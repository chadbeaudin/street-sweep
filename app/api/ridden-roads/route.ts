...
const RIDDEN_VERSION = 7; // bumped: dedupeRiddenRoads now also bridges a short (<=20m) uncovered gap between two covered runs mid-way through the same way, not just at its ends
